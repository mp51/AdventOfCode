...
class Computer:
   def __init__(self, memory_table, extended_memory_size=10000):
      self.reset_memory(memory_table, extended_memory_size)
      self.input_values = []
      self.jump_to = None
   ...
   def set_string_input(self, input_str):
      for c in input_str:
   ...
   def reset_memory(self, initial_memory, extended_size=10000):
      self.table = copy.deepcopy(initial_memory)
      self.table.extend([0]*extended_size)
      self._pos = 0
